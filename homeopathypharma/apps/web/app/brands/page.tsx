...
import { brandImageSrc } from "@/lib/content/images";
        ...
        {brands.map((brand) => (
          <li key={brand.slug}>
            <Link
              ...
              className={`brand-card brand-card--photo hp-focus-ring${brand.featured ? " brand-card--featured" : ""}`}
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src={brandImageSrc(brand.slug)} alt="" width={200} height={200} />
