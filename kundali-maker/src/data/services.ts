...
export const SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    blurbEn: 'Kundali + career chapter pack + year-ahead—still fully self-serve, no calls.',
    blurbHi: 'कुंडली + करियर पैक + वर्ष संकेत—पूरी तरह स्वयं-सेवा, बिना कॉल।',
    audienceEn: 'Power users',
    audienceHi: 'गहन उपयोगकर्ता',
    includesEn: ['Complete kundali PDF', 'Extended career notes', 'Year-ahead PDF add-on', 'Instant unlock'],
    includesHi: ['पूर्ण कुंडली PDF', 'विस्तारित करियर नोट्स', 'वर्ष PDF ऐड-ऑन', 'तुरंत अनलॉक'],
  },
]
