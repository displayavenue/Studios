...
export const SERVICES: ServiceItem[] = [
  {
    ...
    titleEn: 'Vedic Janma Kundali + PDF',
    titleHi: 'वैदिक जन्म कुंडली + PDF',
    blurbEn: 'Exact birth-time chart with lagna, planets, nakshatra, dasha overview, and downloadable PDF.',
    blurbHi: 'सटीक जन्म-समय चार्ट—लग्न, ग्रह, नक्षत्र, महादशा सार व डाउनलोड योग्य PDF।',
    audienceEn: 'Everyone',
    audienceHi: 'सभी',
    includesEn: ['North Indian chart', '9 grahas + houses', 'Nakshatra & pada', 'Mahadasha overview', 'Dosha flags', 'PDF download'],
    includesHi: ['उत्तर भारतीय चार्ट', '९ ग्रह + भाव', 'नक्षत्र व पद', 'महादशा अवलोकन', 'दोष संकेत', 'PDF डाउनलोड'],
    ctaTo: '/generate',
  },
  {
    id: 'remedies',
