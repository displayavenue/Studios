...
export const SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    includesEn: ['36-point gun milan', 'Manglik compare', 'Plain-language summary', 'PDF + WhatsApp confirm'],
    includesHi: ['३६ अंक गुण मिलान', 'मंगलिक तुलना', 'सरल सारांश', 'PDF + WhatsApp पुष्टि'],
    ctaTo: '/milan',
  },
  {
    id: 'career',
